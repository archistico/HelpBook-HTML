...
CREATE TABLE IF NOT EXISTS `contrattiedizione` (
  `idcontrattoedizione` int(11) NOT NULL AUTO_INCREMENT,
  `contrattoedizione` varchar(25) COLLATE utf8_unicode_ci NOT NULL DEFAULT '-',
  `fklibro` int(11) NOT NULL,
  `fkautore` int(11) NOT NULL,
  `datainizio` date NOT NULL,
  `datafine` date NOT NULL,
  `percentualeiniziale` double NOT NULL,
  `percentualefinale` double NOT NULL,
  `copiesostegno` int(11) NOT NULL,
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idcontrattoedizione`),
  KEY `idlibro` (`fklibro`)
...
CREATE TABLE IF NOT EXISTS `iva` (
  ...
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idiva`),
  KEY `idlibrotipologia` (`fktipologia`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `libri` (
  ...
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idlibro`),
  KEY `idcasaeditrice` (`fkcasaeditrice`),
  KEY `idcollana` (`fkcollana`),
  KEY `idlibrotipologia` (`fktipologia`)
...
(1, 1, 'Due non è il doppio di uno', 'La bisessualità come orientamento', '978-88-97192-00-8', 290, 18, 1, 1, 0),
(2, 1, 'I quattro re', '', '978-88-97192-01-5', 340, 18, 2, 1, 0),
(3, 1, 'Ossigeno', '', '978-88-97192-02-2', 172, 14, 3, 1, 0),
(4, 1, 'Emozioni veneziane', '', '978-88-97192-04-6', 102, 13, 2, 1, 0),
(5, 1, 'Di regine, di sante e di streghe', '', '978-88-97192-03-9', 130, 15, 1, 1, 0),
(6, 1, 'L''occasione fa l''uomo laico', '', '978-88-97192-05-3', 236, 16, 3, 1, 0),
...
(15, 1, 'Due non è il doppio di uno', '', '978-88-97192-10-7', 0, 9, 1, 2, 0),
(16, 1, 'I quattro re', '', '978-88-97192-11-4', 0, 5, 2, 2, 0),
(17, 1, 'Ossigeno', '', '978-88-97192-12-1', 0, 6, 3, 2, 0),
(18, 1, 'Di regine, di sante e di streghe', '', '978-88-97192-14-1', 0, 8, 1, 2, 0),
(19, 1, 'Emozioni veneziane', '', '978-88-97192-15-2', 0, 4, 2, 2, 0),
(20, 1, 'L''occasione fa l''uomo laico', '', '978-88-97192-16-9', 0, 8, 3, 2, 0),
(21, 1, 'Uova sbattute', '', '978-88-97192-17-6', 0, 6, 2, 2, 0),
(22, 1, 'Storia di un processo inquisitorio', 'Gostanza da Libbiano', '978-88-97192-18-3', 0, 8, 1, 2, 0),
(23, 1, 'Il lungo inverno di Spitak', '', '978-88-97192-19-0', 0, 8, 1, 2, 0),
(24, 1, 'Sogni inquinati', '', '978-88-97192-20-6', 0, 1, 2, 2, 0),
(25, 1, 'Poi, ho smesso', '', '978-88-97192-21-3', 176, 12, 2, 1, 0),
(26, 1, 'Poi, ho smesso', '', '978-88-97192-22-0', 0, 6, 2, 2, 0),
(27, 1, 'Storie di fate, di dee e di eroi', '', '978-88-97192-13-8', 200, 16, 1, 1, 0),
(28, 1, 'Cripta', '', '978-88-97192-24-4', 0, 15, 2, 1, 0),
(29, 1, 'Domina Herbarum', 'Storia di una guaritrice nella Toscana dei Medici', '978-88-97192-23-7', 48, 10, 1, 1, 0),
(30, 1, 'Il custode di Izu', '', '978-88-97192-26-8', 72, 5, 2, 1, 0),
(31, 1, 'L''origine delle parole', 'Vita e opere di Pompilio Sulbus tentato di pensare', '978-88-97192-40-4', 0, 0, 4, 2, 0),
(32, 1, 'Oxygen', '', '978-88-97192-25-1', 0, 4, 6, 2, 0),
...
(98, 1, 'La riunione di condominio', '', '978-88-97192-42-8', 0, 0, 4, 2, 0),
(99, 1, 'I consigli d''amore', '', '978-88-97192-41-1', 0, 0, 4, 2, 0),
...
(130, 5, 'Le rondini non si scontrano mai', '', '978-88-97347-15-6', 0, 10, 7, 1, 0),
(131, 5, 'Io e Nilde', '', '978-88-97347-10-1', 0, 12, 7, 1, 0),
(132, 5, 'Se ti scappa, falla... la risata', '', '978-88-97347-31-6', 0, 13, 7, 1, 0),
...
(137, 5, 'La talpa Giuditta presenta: Trattamento cretinetti per zittire i bulletti', '', '978-88-97347-14-9', 0, 13, 7, 1, 0),
...
(141, 5, 'Adalgisa e la luna', '', '978-88-97347-11-8', 0, 12, 7, 1, 0),
(142, 5, 'Le avventure di Togo e Ringo', '', '978-88-97347-00-2', 0, 13, 7, 1, 0),
(143, 5, 'Ci sono anch''io', '', '978-88-97347-02-6', 0, 13, 7, 1, 0),
...
(147, 5, 'Ma in un libro cosa c''è', '', '978-88-97347-22-4', 0, 12, 7, 1, 0),
...
(150, 7, 'Il contrabbasso', '', '978-88-89759-18-9', 0, 18, 7, 1, 0),
...
(157, 10, 'L''identità romana', '', '978-88-90593-47-5', 0, 21, 7, 1, 0),
...
(203, 5, 'Pronto in 10 mosse', '', '978-88-97347-27-9', 44, 12, 7, 1, 0),
...
(216, 1, 'Cripta', '', '978-88-97192-30-5', 0, 5, 2, 2, 0),
(217, 1, 'Desideri sommersi', '', '978-88-97192-29-9', 0, 4, 5, 2, 0),
...
(223, 1, 'Seconda classe, lato finestrino', '', '978-88-97192-56-5', 0, 4, 2, 2, 0),
(224, 1, 'Le long Hivier de Spitak', '', '978-88-97192-58-9', 0, 8, 6, 2, 0),
...
CREATE TABLE IF NOT EXISTS `libritipologia` (
  `idlibrotipologia` int(11) NOT NULL AUTO_INCREMENT,
  `librotipologia` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idlibrotipologia`)
...
--
-- Struttura della tabella `magazzinimovimenti`
--

CREATE TABLE IF NOT EXISTS `magazzinimovimenti` (
  `idmagazzinomovimento` int(11) NOT NULL AUTO_INCREMENT,
  `fkmagazzino` int(11) NOT NULL,
  `fkmovimentodettaglio` int(11) DEFAULT NULL,
  `descrizione` varchar(100) COLLATE utf8_unicode_ci NOT NULL DEFAULT '-',
  `fklibro` int(11) NOT NULL,
  `entrata` int(11) NOT NULL,
  `uscita` int(11) NOT NULL,
  PRIMARY KEY (`idmagazzinomovimento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `movimenti` (
  ...
  KEY `idmovimentotipologia` (`fktipologia`),
  KEY `idsoggetto` (`fksoggetto`),
  KEY `idpagamentotipologia` (`fkpagamentotipologia`),
  KEY `idmovimentoaspetto` (`fkaspetto`),
  KEY `idmovimentotrasporto` (`fktrasporto`)
...
INSERT INTO `movimenti` (`idmovimento`, `fktipologia`, `fkcausale`, `numero`, `anno`, `riferimento`, `fksoggetto`, `movimentodata`, `pagamentoentro`, `pagata`, `fkpagamentotipologia`, `datapagamento`, `spedizionecosto`, `spedizionesconto`, `fkaspetto`, `fktrasporto`, `note`, `cancellato`) VALUES
(1, 1, 5, 1, 2016, '', 169, '2016-06-02', '2016-06-02', 1, 9, NULL, 1.28, 100, 2, 3, '', 0),
(2, 4, 4, 1, 2016, '', 121, '2016-06-03', '2016-06-16', 0, 3, NULL, 1.28, 0, 3, 3, '', 0),
(3, 1, 5, 2, 2016, '', 200, '2016-06-02', '2016-06-09', 1, 9, NULL, 0, 0, 1, 1, '', 0),
(4, 2, 1, 1, 2016, '', 169, '2016-06-08', '2016-06-08', 1, 6, NULL, 0, 0, 1, 2, '', 0),
(5, 5, 1, 1, 2016, '', 294, '2016-06-02', '2016-06-09', 1, 6, NULL, 0, 0, 2, 2, '', 0),
(6, 3, 1, 1, 2016, '', 116, '2016-06-02', '2016-06-09', 0, 3, NULL, 5.49, 50, 2, 3, '', 0),
(7, 3, 5, 2, 2016, '', 8, '2016-06-03', '2016-06-08', 1, 9, NULL, 0, 0, 2, 2, '', 0);
...
CREATE TABLE IF NOT EXISTS `movimentiaspetto` (
  `idmovimentoaspetto` int(11) NOT NULL AUTO_INCREMENT,
  `movimentoaspetto` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idmovimentoaspetto`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `movimenticausale` (
  `idmovimentocausale` int(11) NOT NULL AUTO_INCREMENT,
  `movimentocausale` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idmovimentocausale`)
...
CREATE TABLE IF NOT EXISTS `movimentidettaglio` (
  `idmovimentodettaglio` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `movimentidettaglio` (`idmovimentodettaglio`, `fkmovimento`, `fklibro`, `quantita`, `sconto`, `cancellato`) VALUES
(15, 5, 149, 1, 0, 0),
(16, 5, 247, 5, 30, 0),
(17, 2, 28, 5, 30, 0),
(20, 2, 21, 1, 10, 0),
...
CREATE TABLE IF NOT EXISTS `movimentitipologia` (
  `idmovimentotipologia` int(11) NOT NULL AUTO_INCREMENT,
  `movimentotipologia` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `codice` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idmovimentotipologia`)
...
CREATE TABLE IF NOT EXISTS `movimentitrasporto` (
  `idmovimentotrasporto` int(11) NOT NULL AUTO_INCREMENT,
  `movimentotrasporto` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idmovimentotrasporto`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `pagamentitipologia` (
  `idpagamentotipologia` int(11) NOT NULL AUTO_INCREMENT,
  `pagamentotipologia` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idpagamentotipologia`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `soggetti` (
  ...
  KEY `idsoggettotipologia` (`fktipologia`)
...
(118, 10, 'Elmi''s World Casa Editrice di Elettra Groppo', '', '', '01146370075', '', 'info@elmisworld.it', 'Via Guillet, 6', '11027', 'Saint Vincent', 'Ao', '', 0),
...
(197, 12, '00 Magazzino EW', '', '', '', '', '', '', '', 'Saint Vincent', '', '', 0),
...
CREATE TABLE IF NOT EXISTS `soggettitipologia` (
  `idsoggettotipologia` int(11) NOT NULL AUTO_INCREMENT,
  `soggettotipologia` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idsoggettotipologia`)
...
CREATE TABLE IF NOT EXISTS `spese` (
  ...
  PRIMARY KEY (`idspesa`),
  KEY `idsoggetto` (`fksoggetto`),
  KEY `idspesatipologia` (`fktipologia`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `spesetipologia` (
  `idspesatipologia` int(11) NOT NULL AUTO_INCREMENT,
  `spesatipologia` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idspesatipologia`)
...
CREATE TABLE IF NOT EXISTS `stampe` (
  `idstampa` int(11) NOT NULL AUTO_INCREMENT,
  `fklibro` int(11) NOT NULL,
  ...
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idstampa`),
  KEY `idlibro` (`fklibro`),
  KEY `idtipografia` (`fktipografia`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `utenti` (
  ...
  `utentenome` varchar(12) COLLATE utf8_unicode_ci NOT NULL,
  `utentepw` varchar(12) COLLATE utf8_unicode_ci NOT NULL,
  `utentemail` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '-',
  `fktipologia` int(11) NOT NULL DEFAULT '5',
  `cancellato` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`idutente`),
  KEY `idutentetipologia` (`fktipologia`)
...
INSERT INTO `utenti` (`idutente`, `utentenome`, `utentepw`, `utentemail`, `fktipologia`, `cancellato`) VALUES
(1, 'emilie', 'e', 'emilie.rollandin@gmail.com', 1, 0);

-- --------------------------------------------------------

--
-- Struttura della tabella `utentitipologia`
--

CREATE TABLE IF NOT EXISTS `utentitipologia` (
  `idutentitipologia` int(11) NOT NULL AUTO_INCREMENT,
  `utentetipologia` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`idutentitipologia`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=6 ;

--
-- Dump dei dati per la tabella `utentitipologia`
--

INSERT INTO `utentitipologia` (`idutentitipologia`, `utentetipologia`) VALUES
(1, 'Amministratore'),
(2, 'Editore'),
(3, 'Collaboratore'),
(4, 'Autore'),
